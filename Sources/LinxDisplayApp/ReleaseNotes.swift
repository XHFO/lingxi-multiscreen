...
enum ReleaseNotes {
    static let all: [ReleaseNote] = [
        ReleaseNote(id: "1.5.4", date: "2026-09-08", notes: [
            ...
            "适配 ESP8266 AI Mac 小屏幕固件：0.8.0 使用 115,200 字节大端 RGB565 无损帧；旧固件自动回退到 24KB 内 JPEG 兼容推送。",
            "AI Mac 刷机流程支持提前填写 2.4 GHz Wi-Fi：固件与临时配网区一次写入，刷写成功后自动等待设备联网、获取 IP 并添加；密码不保存，联网后设备会擦除临时配网区。",
